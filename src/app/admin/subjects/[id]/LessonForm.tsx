  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <div style={inputGroupStyle}>
            ...
            <input
              ...
              placeholder={
                type === "quiz"
                  ? "Contoh: Kuis Dasar JS"
                  : type === "project"
                    ? "Contoh: Tugas Akhir Modul"
                    : type === "code"
        ...
        <div style={inputGroupStyle}>
          <label style={labelStyle}>
            Deskripsi Singkat (Muncul di daftar kursus)
          </label>
          <textarea
            name="description"
        ...
        >
          ...
          {type === "video" && (
            <div style={inputGroupStyle}>
              <input
                name="contentUrl"
                type="url"
                placeholder="Link YouTube atau Loom"
                required
                style={{ width: "100%" }}
              />
            </div>
          ...
          {type === "quiz" && (
            ...
            >
              ...
              >
                ...
                >
                  Gunakan Bank Soal (Kuis Dinamis)
                </label>
              </div>
              ...
              {isDynamic ? (
                ...
                >
                  Mode Statik: Buat kuis terlebih dahulu, lalu tambahkan
                  pertanyaan secara manual dari daftar materi.
                </p>
              )}
            </div>
          )}
          ...
          {type === "project" && (
            <p style={{ margin: 0, fontSize: "0.875rem", color: "#64748B" }}>
              Siswa akan diminta untuk mengunggah atau mengirimkan link hasil
              pekerjaan mereka.
            </p>
          )}
            ...
            >
              ...
              >
                ...
                <div>
                  ...
                  >
                    Siswa akan mengerjakan soal coding langsung di built-in IDE.
                    Setelah membuat lesson ini, Anda bisa mengatur soal, starter
                    code, dan test cases dari halaman detail materi.
                  </p>
                </div>
              </div>
            </div>
            ...
            >
              ...
              >
                ...
                <div>
                  ...
                  >
                    Siswa akan menulis CSS dengan live preview. Setelah membuat
                    lesson ini, Anda bisa mengatur soal, boilerplate HTML, dan
                    referensi jawaban dari halaman detail materi.
                  </p>
                </div>
              </div>
            </div>
