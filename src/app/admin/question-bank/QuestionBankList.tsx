...
export default function QuestionBankList({ initialQuestions }: QuestionBankListProps) {
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
        {filteredQuestions.map((q) => (
          <div key={q.id} className="card" style={{ padding: '20px' }}>
            ...
            <p style={{ fontWeight: 600, fontSize: '1.1rem', marginBottom: '16px' }}>{q.question_text}</p>
              ...
              {q.options.map((opt: string, i: number) => (
                <div 
                  ...
                  style={{ 
                    ...
                    backgroundColor: i === q.correct_option_index ? '#F0FDF4' : 'transparent',
                    borderColor: i === q.correct_option_index ? '#86EFAC' : '#E2E8F0',
                    display: 'flex',
                    alignItems: 'center',
                    gap: '8px'
                  }}
                >
                  ...
                  <span style={{ fontSize: '0.875rem', color: i === q.correct_option_index ? '#166534' : 'inherit' }}>
                    {opt}
                  </span>
