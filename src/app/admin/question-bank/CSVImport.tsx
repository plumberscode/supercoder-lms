...
export default function CSVImport({ subjects }: CSVImportProps) {
  ...
  return (
    <div
      className="card"
      style={{ padding: "24px", backgroundColor: "#F8FAFC" }}
    >
      <h3 style={{ marginBottom: "16px" }}>Impor via CSV</h3>
      <p
        style={{ fontSize: "0.875rem", color: "#64748B", marginBottom: "20px" }}
      >
        Gunakan format:{" "}
        <code>
          kategori, soal, opsi1, opsi2, opsi3, opsi4, index_benar, poin
        </code>
      </p>
      ...
      <div style={{ marginTop: "16px", fontSize: "0.75rem", color: "#94A3B8" }}>
        * <code>index_benar</code> adalah angka 0-3 (0 untuk opsi1, 1 untuk
        opsi2, dst.)
      </div>
    </div>
  );
