        ...
        {submissions?.map((sub) => (
          ...
          >
            <div>
              ...
              >
                <span
                  ...
                  style={{
                    backgroundColor:
                      sub.status === "graded" ? "#DCFCE7" : "#FEF3C7",
              ...
              <h3 style={{ marginBottom: "4px" }}>
                {(sub as any).profiles.full_name || (sub as any).profiles.email}
              </h3>
              <p
                style={{
                  color: "#64748B",
              ...
              >
                Telah mengirimkan proyek untuk ditinjau.
              </p>
            ...
            >
              ...
              <form
                action={gradeSubmission.bind(null, sub.id)}
                className="form"
              >
                ...
                >
                  ...
                  <textarea
                    ...
                    rows={3}
                    placeholder="Bagus sekali! Selanjutnya coba untuk..."
                  ></textarea>
                </div>
                <button
                  type="submit"
