...
export default function ChallengeEditor({
  ...
  const handleAddTestCase = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    if (!existingChallenge) {
      showToast(
        "Simpan soal terlebih dahulu sebelum menambah test case",
        "error",
      );
      return;
    }
    ...
    <div>
      ...
      <div style={cardStyle}>
        ...
        >
          ...
          {language === "html-js" && (
            <div style={inputGroupStyle}>
              <label style={labelStyle}>
                Starter HTML (Struktur HTML awal yang diberikan ke siswa)
              </label>
              <textarea
                name="starterHtml"
                placeholder={
          ...
          <div style={inputGroupStyle}>
            <label style={labelStyle}>
              {language === "html-js"
                ? "Starter JavaScript (Kode JS awal)"
                : "Starter Code (Kode awal yang diberikan ke siswa)"}
            </label>
            <textarea
              name="starterCode"
              placeholder={
          ...
          <div style={inputGroupStyle}>
            <label style={labelStyle}>
              Solution Code (Jawaban benar — hanya untuk referensi guru)
            </label>
            <textarea
              name="solutionCode"
          ...
          <div style={inputGroupStyle}>
            <label style={labelStyle}>
              Hints / Petunjuk (satu per baris — ditampilkan secara progresif
              saat siswa gagal)
            </label>
            <textarea
              name="hints"
              placeholder={
                "Coba pikirkan operator apa yang digunakan untuk menjumlahkan dua angka\nPerhatikan bahwa fungsi harus mengembalikan (return) hasilnya, bukan hanya menghitungnya\nGunakan keyword 'return' untuk mengembalikan nilai dari fungsi"
              }
              defaultValue={
                existingChallenge?.hints
                  ? Array.isArray(existingChallenge.hints)
                    ? existingChallenge.hints.join("\n")
                    : ""
                  : ""
              }
              rows={4}
            ...
            <p style={{ fontSize: "0.75rem", color: "#94A3B8", margin: 0 }}>
              Hint pertama ditampilkan setelah percobaan pertama yang gagal,
              hint kedua setelah percobaan kedua, dst. Jika AI Hint diaktifkan,
              AI akan memberikan saran tambahan.
            </p>
          </div>
      ...
      {language !== "html-js" && (
        <div style={cardStyle}>
          ...
          >
            Test case digunakan untuk mengecek apakah jawaban siswa benar. Siswa
            hanya bisa melihat test case yang tidak tersembunyi.
          </p>
                ...
                >
                  ...
                  >
                    <div style={inputGroupStyle}>
                      ...
                      <input
                        name="title"
                        placeholder="Contoh: Test penjumlahan positif"
                        required
                        style={inputStyle}
                      />
                    </div>
                  ...
                  >
                    <div style={inputGroupStyle}>
                      <label style={labelStyle}>
                        {language === "html-js"
                          ? "DOM Assertion (JavaScript yang return string)"
                          : "Input (kode yang dijalankan setelah kode siswa)"}
                      </label>
                      <textarea
                        name="input"
                        placeholder={
                  ...
                  <input
                    type="hidden"
                    name="orderIndex"
                    value={existingTestCases.length}
                  />
                  <button
                    type="submit"
                    className="btn btn-primary"
