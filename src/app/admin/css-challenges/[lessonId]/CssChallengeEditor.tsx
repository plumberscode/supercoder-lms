...
export default function CssChallengeEditor({
  lessonId,
  existingChallenge,
}: Props) {
    ...
    <div>
      <div style={cardStyle}>
        ...
        >
          ...
          <div style={inputGroupStyle}>
            <label style={labelStyle}>
              Boilerplate HTML (Struktur HTML yang diberikan ke siswa)
            </label>
            <textarea
              name="starterHtml"
              placeholder={
          ...
          <div style={inputGroupStyle}>
            ...
            />
            <span style={{ fontSize: "0.75rem", color: "#64748B" }}>
              CSS awal yang sudah terisi saat siswa membuka soal. Biarkan kosong
              jika siswa harus menulis dari awal.
            </span>
          </div>

          <div style={inputGroupStyle}>
            <label style={labelStyle}>
              Reference CSS (Jawaban referensi guru)
            </label>
            <textarea
              name="referenceCss"
              placeholder={
            ...
            />
            <span style={{ fontSize: "0.75rem", color: "#64748B" }}>
              CSS referensi yang digunakan sebagai acuan perbandingan visual.
              Hanya terlihat oleh guru.
            </span>
          </div>
