      ...
      >
        ...
        >
          ...
          <div style={{ display: "flex", alignItems: "center", gap: "16px" }}>
            <a
              href={`https://wa.me/6287788931919?text=${encodeURIComponent(`Halo Instruktur Supercoder, saya ingin bertanya seputar materi: ${lesson.title}`)}`}
              target="_blank"
        ...
        <div className="card" style={{ marginBottom: "40px" }}>
          ...
          {lesson.type === "code" && !codingChallenge && (
            <div style={{ padding: "40px", textAlign: "center" }}>
              ...
              <p style={{ color: "#64748B" }}>
                Soal coding untuk materi ini belum dibuat oleh guru.
              </p>
            </div>
          )}
          ...
          {lesson.type === "css-challenge" && !cssChallenge && (
            <div style={{ padding: "40px", textAlign: "center" }}>
              ...
              <h3>CSS Challenge</h3>
              <p style={{ color: "#64748B" }}>
                Soal CSS untuk materi ini belum dibuat oleh guru.
              </p>
            </div>
          )}
        </div>
