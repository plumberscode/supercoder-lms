...
export default function ProjectSubmission({ lessonId }: { lessonId: string }) {
  ...
  return (
    <div className="card" style={{ border: '2px dashed var(--border)', backgroundColor: '#F8FAFC' }}>
      ...
      {!submitted ? (
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '12px', color: 'var(--success)' }}>
          ...
          <div>
            ...
            <div style={{ fontSize: '0.875rem' }}>Instruktur akan meninjau dan memberi nilai segera.</div>
          </div>
        </div>
      )}
    </div>
